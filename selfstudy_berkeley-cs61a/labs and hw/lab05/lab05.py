...
def my_map(fn, seq: list) -> list:
    ...
    [None, None, None]
    """
    return [fn(each_item) for each_item in seq]


def my_filter(pred, seq: list) -> list:
    ...
    [1, 2, 3, 4, 5]
    """
    return [each_item for each_item in seq if pred(each_item)]
