...
def tail_points(opponent_score):
    ...
    Roger: I defined the test cases; written assuming only positive integers for input argument
    >>> tail_points(55)
    1
    >>> tail_points(93)
    13
...
def perfect_square(number):
    """ Checks if a number is a perfect square and returns a boolean value
    >>> perfect_square(1)
    True
    >>> perfect_square(37)
    False
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    score0, score1 = 0,0
    base_roll = strategy(score0, score1)
    while score0 < goal:
        while score1 < goal:
            if strategy(score0, score1) != base_roll:
                return False
            score1 += 1
        score1 = 0
        score0 += 1
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    roll_num, best_roll_num, best_score = 1, 1, 0
    while roll_num <= 10:
        a_score = make_averaged(roll_dice, total_samples)(roll_num, dice)
        if a_score > best_score:
            best_roll_num = roll_num
            best_score = a_score
        roll_num += 1
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    if score + tail_points(opponent_score) >= score + threshold:
        return 0
...
if __name__ == "__main__":
    ...
    # roll_dice(3)
    # roll_dice(0)
    # print(tail_points(55))
    # print(tail_points(93))
    # print(tail_points(43528))
    # print(tail_points(3))
    import doctest
    doctest.testmod()